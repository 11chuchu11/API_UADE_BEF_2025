                    ...
                    <div>
                        <h2 className="text-3xl md:text-5xl font-extrabold text-foreground leading-tight">
                            ...
                            <span className="block">
                                {texts.contact.titleLine2Prefix}{" "}
                                <span className="text-primary">{texts.contact.doctorFullName}</span>
                            </span>
                        </h2>
                        ...
                        <div className="mt-8">
                            <ActionButton icon={<FaWhatsapp className="h-5 w-5" />}>
                                {texts.contact.buttonLabel}
                            </ActionButton>
                        </div>
                    </div>
